...
- [Student Management System](https://github.com/ANG13T/student-management-system): Public repository
- [AI-Free-Tools-List](https://github.com/ANG13T/AI-Free-Tools-List): Public repository
- [SCSS](https://github.com/ANG13T/SCSS): 
- [vutifyadmin](https://github.com/ANG13T/vutifyadmin): Public repository
- [Windows 11 Clone](https://github.com/ANG13T/windows-clone): It is a web application that allows users to experience the look and feel of Windows 11 without having to install the operating system on their computer. The Windows 11 Web clone is built using HTML, CSS, and JavaScript.
- [Dental Clinic Management System](https://github.com/ANG13T/dental-clinic-management-system): Public repository
- [WebNmap](https://github.com/ANG13T/WebNmap): WebNmap is a web-based tool for performing network scans using Nmap, offering an intuitive interface to execute commands and view results directly in the browser. Ideal for network administrators a
